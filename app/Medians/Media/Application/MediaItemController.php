...
class MediaItemController extends CustomController 
{
    ...
    public function upload_info($media_id)
    {
        ...
        {
            $generateWave = $this->generateWave( str_replace($this->repo->_dir, '',  $filePath));
        }
    ...
    public function generateWave($file)
    {
        ...
        echo shell_exec($ffmpeg.' -i '.$filePath.'  -filter_complex "showwavespic=s=1024x200" -frames:v 1  '.$outputPath.' ');
    }
