import{o as l,c as u,a as q,am as K,w as O,d as m,F as M,f as A,N as I,a2 as F,O as z,e as H,P as N,b as w,ad as R,v as $,n as C,u as G,a3 as W}from"./index.min.js";var J=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function U(e,n,t){return t={path:n,exports:{},require:function(s,r){return Q(s,r??t.path)}},e(t,t.exports),t.exports}function Q(){throw new Error("Dynamic requires are not currently supported by @rollup/plugin-commonjs")}var X=U(function(e,n){(function(t,s){e.exports=s()})(J,function(){var t="__v-click-outside",s=typeof window<"u",r=typeof navigator<"u",i=s&&("ontouchstart"in window||r&&navigator.msMaxTouchPoints>0)?["touchstart"]:["click"],k=function(a){var c=a.event,h=a.handler;(0,a.middleware)(c)&&h(c)},T=function(a,c){var h=function(o){var f=typeof o=="function";if(!f&&typeof o!="object")throw new Error("v-click-outside: Binding value must be a function or an object");return{handler:f?o:o.handler,middleware:o.middleware||function(v){return v},events:o.events||i,isActive:o.isActive!==!1,detectIframe:o.detectIframe!==!1,capture:!!o.capture}}(c.value),b=h.handler,B=h.middleware,D=h.detectIframe,S=h.capture;if(h.isActive){if(a[t]=h.events.map(function(o){return{event:o,srcTarget:document.documentElement,handler:function(f){return function(v){var x=v.el,g=v.event,_=v.handler,y=v.middleware,E=g.path||g.composedPath&&g.composedPath();(E?E.indexOf(x)<0:!x.contains(g.target))&&k({event:g,handler:_,middleware:y})}({el:a,event:f,handler:b,middleware:B})},capture:S}}),D){var j={event:"blur",srcTarget:window,handler:function(o){return function(f){var v=f.el,x=f.event,g=f.handler,_=f.middleware;setTimeout(function(){var y=document.activeElement;y&&y.tagName==="IFRAME"&&!v.contains(y)&&k({event:x,handler:g,middleware:_})},0)}({el:a,event:o,handler:b,middleware:B})},capture:S};a[t]=[].concat(a[t],[j])}a[t].forEach(function(o){var f=o.event,v=o.srcTarget,x=o.handler;return setTimeout(function(){a[t]&&v.addEventListener(f,x,S)},0)})}},d=function(a){(a[t]||[]).forEach(function(c){return c.srcTarget.removeEventListener(c.event,c.handler,c.capture)}),delete a[t]},p=s?{beforeMount:T,updated:function(a,c){var h=c.value,b=c.oldValue;JSON.stringify(h)!==JSON.stringify(b)&&(d(a),T(a,{value:h}))},unmounted:d}:{};return{install:function(a){a.directive("click-outside",p)},directive:p}})}),Y=X;const Z={class:"v3ti-loader-wrapper"},ee=m("div",{class:"v3ti-loader"},null,-1),te=m("span",null,"Loading",-1),ne=[ee,te];function ie(e,n){return l(),u("div",Z,ne)}function L(e,n){n===void 0&&(n={});var t=n.insertAt;if(!(!e||typeof document>"u")){var s=document.head||document.getElementsByTagName("head")[0],r=document.createElement("style");r.type="text/css",t==="top"&&s.firstChild?s.insertBefore(r,s.firstChild):s.appendChild(r),r.styleSheet?r.styleSheet.cssText=e:r.appendChild(document.createTextNode(e))}}var ae=`.v3ti-loader-wrapper {
  display: flex;
  align-items: center;
...
.v3ti .v3ti-new-tag--error {
  color: #F56C6C;
}`;L(ye);V.render=we;var Te=(()=>{const e=V;return e.install=n=>{n.component("Vue3TagsInput",e)},e})();export{Te as e};
