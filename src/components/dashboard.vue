        ...
        <div class="block w-full overflow-x-auto py-2" v-if="content">
            <div class="w-full overflow-y-auto overflow-x-hidden px-2 mt-6" >
                        ...
                        <div class="card-header pt-5">
                            <div class="card-title d-flex flex-column">   
                                <div class="d-flex align-items-center">
                                    <span class="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2" v-text="content.visits_count"></span>
                                </div>
                ...
                <div class="">
                    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mb-6">
                        <div class="relative overflow-hidden">
                            <dashboard_card_white  icon="/uploads/img/booking-unpaid.png" classes="bg-dark pb-30" text_class="fs-4 text-white" value_class="text-white" :title="translate('Total Articles')" :value="content.articles_count"></dashboard_card_white>
                            <line_charts  class="absolute bottom-0 w-full mb-8"  v-if="content.articles_charts" type="bar" :key="content" :data="getChartData(content.articles_charts, 'label', 'y')" />
                        </div>
                        
                        <div class="relative overflow-hidden">
                            <dashboard_card_white  icon="/uploads/img/booking-paid.png" classes="bg-info pb-30" text_class="fs-4 text-white" value_class="text-white"  :title="translate('Total Pages')" :value="content.pages_count"></dashboard_card_white>
                            <line_charts class="absolute bottom-0 w-full mb-8"  v-if="content.pages_count" type="bar" :key="content" :data="getChartData(content.pages_charts, 'label', 'y')" />
                        </div>
                        ...
                        <div class="relative overflow-hidden">
                            ...
                            <line_charts  class="absolute bottom-0 w-full mb-8"  v-if="content.visits_charts" type="bar" :key="content" :data="getChartData(content.visits_charts, 'date', 'y')" />
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full py-10">
                    <h4 class="text-base lg:text-lg " v-text="translate('Visitors charts')"></h4> 
                    <div class="w-full bg-white p-4 mb-4 rounded-lg" v-if="content.visits_charts">
                        <dashboard_pie_chart v-if="content.visits_charts" type="bar"  :key="content" :options="getChartData(content.visits_charts, 'date', 'y', colors[2])" />
                    </div>
                </div>
                ...
                <div class="w-full lg:flex gap gap-6 pb-6">
                    <div class="card mb-0 w-full lg:w-1/3">
                        ...
                        <div class="card-body w-full">
                            <div class="w-full" >
                                <dashboard_pie_chart v-if="content.top_visits" type="pie"  :key="content.top_visits" :options="getPieChartData(content.top_visits, 'times')" />
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table class="w-full table table-striped table-nowrap custom-table mb-0 datatable">
                                        ...
                                        <tbody v-if="content.top_visits"  :key="content.top_visits">
                                            <tr :key="index" v-for="(item, index) in content.top_visits"  >
                                                ...
                                                <td v-text="item && item.item && item.item.name ? item.item.name : item.class"></td>
                        ...
                        <div class="w-full">
                            <div class="table-responsive w-full">
                                <table class="w-full table table-striped table-nowrap custom-table mb-0 datatable">
                                    ...
                                    <tbody >
                                        <tr :key="index" v-for="(booking, index) in content.latest_contact_messages" >
                                            <td v-text="booking.name ?? ''"></td>
                                            <td v-text="booking.email ?? ''"></td>
                                            <td v-text="booking.phone ?? ''"></td>
                                            <td v-text="booking.message ?? ''"></td>
