                                            ...
                                            <table
                                                ...
                                                <tbody class="text-gray-600">
                                                    <tr
                                                        ...
                                                        <td >
                                                            <span class="cursor-pointer bg-danger text-white text-base py-2 px-4 rounded" @click="confirmStock(orderItem, 'confirm')" v-if="!orderItem.stock_updated" v-text="translate('Confirm')"></span>
                                                            <span class="cursor-pointer text-white text-base py-2 px-4 rounded bg-gradient-purple" @click="confirmStock(orderItem, 'rollback')" v-if="orderItem.stock_updated" v-text="translate('Rollback')"></span>
                                                        </td>
                                                        <td  >
