<template>
    <div class="w-full flex overflow-auto">
                ...
                <div class="action form d-flex flex-column flex-lg-row">
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        <div class="card card-flush py-4">
                            <div class="card-header">
                                <div class="card-title">
                                    <h2 v-text="translate('Main picture')"></h2>
                                </div>
                            </div>
                            <div class="card-body text-center pt-0 ">

                                <div
                                    class="image-input image-input-empty image-input-outline image-input-placeholder mb-3 w-full">
                                    <vue-medialibrary-field @changed="(val) => { activeItem.picture = val;}"
                                        :key="activeItem" name="params[picture]" :filepath="activeItem.picture"
                                        v-if="conf" :api_url="conf.url"></vue-medialibrary-field>
                                </div>
                        ...
                        <div class="card card-flush py-4">
                            <div class="card-header">
                                <div class="card-title">
                                    <h2 v-text="translate('Product Details')"></h2>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                ...
                                <form_field @callback="(val) => {console.log(val), activeItem.product_categories = val}"
                                    :item="activeItem"
                                    :column="{multiple:true, key:'product_categories',title: translate('Main Category') , column_type:'select', text_key: 'name', column_key: 'category_id', data: categories}">
                                </form_field>

                                <div class="text-muted fs-7 mb-7" v-text="translate('Add item to multi categories')">
                                </div>
                                <a href="javascript:;" @click="showAddCategory = true"
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <vue3-tags-input @on-tags-changed="val => activeItem.tags = val" :tags="activeItem.tags"
                        ...
                        <div class="card card-flush py-4">
                            <div class="card-header">
                                <div class="card-title">
                                    <h2 v-text="translate('Shipping')"></h2>
                                </div>
                            </div>
                            <div class="card-body pt-0" v-if="shipping" :key="shipping">

                                <label class="form-label" v-text="translate('Shipping')"></label>
                                <form_field @callback="(val) => {activeItem.shipping = val}" :item="activeItem"
                                    :column="{multiple:true, key:'shipping',title: translate('shipping') , column_type:'select', text_key: 'name', column_key: 'shipping_id', data: shipping}">
                                </form_field>
                        ...
                        <div class="card card-flush py-4">
                            <div class="card-header">
                                <div class="card-title">
                                    <h2 v-text="translate('Brand')"></h2>
                                </div>
                            </div>
                            <div class="card-body pt-0" v-if="brands" :key="brands">
                                <label class="form-label" v-text="translate('Product Brand')"></label>
                                <form_field :key="brands" :item="activeItem.product_fields"
                                    :column="{key:'brand_id',title: translate('Brand') , column_type:'select', text_key: 'name', column_key: 'brand_id', data: brands}">
                                </form_field>
                        ...
                        <div class="card card-flush py-4">
                            <div class="card-header">
                                <div class="card-title">
                                    <h2 v-text="translate('Page Template')"></h2>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                <label v-text="translate('Select a item template')" class="form-label"></label>
                                <form_field :item="activeItem.product_fields"
                                    :column="{required: true, key:'template',title: translate('Template') , column_type:'select', text_key: 'title', column_key: 'value', data:templates}">
                                </form_field>
                                <div class="text-muted fs-7"
                                    v-text="translate('Assign a template from your current theme to define how a single item is displayed')">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="tab-content">
                                                ...
                                                <div class="card-body pt-0" v-if="seoLang == language.language_code">
                                                    <div class="mb-10 fv-row">
                                                        <label class="required form-label "><span
                                                                v-text="translate('Path')"></span><strong class="px-4"
                                                                v-text="translate(language.language_code)"></strong></label>
                                                        <div class="position-relative flex">
                                                            <input :disabled="true" :value="conf.url"
                                                                class="bg-gray-200 form-control-solid px-4" />
                                                            <input type="text"
                                                                v-model="getLang(activeItem, language.language_code).prefix"
                                                                class="form-control form-control-solid" />
                                                        </div>
                                                        <div class="text-muted fs-7"
                                                            v-text="translate('URL path for the item webpage')"> </div>
                                                    </div>
                                                    <div class="mb-10 fv-row">
                                                        <label class="required form-label "><span
                                    ...
                                    <div class="w-full">
                                        <div v-for="language in langs" :key="language">
                                            ...
                                            <div class="card card-flush py-4" v-if="seoLang == language.language_code">
                                                <div class="card-header flex flex-nowrap">
                                                    <div class="w-full card-title">
                                                        <h2 v-text="translate('Meta Options')"></h2>
                                                    </div>
                                                    <ul class="flex gap-10 flex-none">
                                                        <li class="text-lg flex py-5 gap-2 cursor-pointer"
                                                            @click="seoLang = langKey.language_code"
                                                            v-for="langKey in langs">
                                                            <img :src="langKey.icon"
                                                                class="rounded-full w-10 h-10 border-1 border border-gray-600 p-1" />
                                                            <a href="javascript:;"
                                                                :class="langKey.language_code == seoLang ? 'text-danger font-bold' : 'opacity-75 text-gray-400'"
                                                ...
                                                <div class="card-body pt-0">
                                                    <div class="mb-10">
                                                        <label class="form-label"
                                                            v-text="translate('Meta Tag Title') + ' (' + language.language_code + ')'"></label>
                                                        <input type="text" class="form-control mb-2" name="meta_title"
                                                            :placeholder="translate('Meta tag name')"
                                                            v-model="activeItem.content_langs[language.language_code].seo_title" />
                                                        <div class="text-muted fs-7"
                                                            v-text="translate('Set a meta tag title. Recommended to be simple and precise keywords') + ' (' + language.name + ')'">
                                                        </div>
                                                    </div>

                                                    <div class="mb-10">
                                                        <label class="form-label"
                                                            v-text="translate('Meta Tag Description')"></label>
                                                        <textarea
                                                            v-model="activeItem.content_langs[language.language_code].seo_desc"
                                                            class=""></textarea>
                                                        <div class="text-muted fs-7"
                                                            v-text="translate('Set a meta tag description to the item for increased SEO ranking')">
                                                        </div>
                                                    </div>

                                                    <div>
                                                        <label class="form-label"
                                                            v-text="translate('Meta Tag Keywords')"></label>
                                                        <input id="kt_ecommerce_add_item_meta_keywords"
                                                            class="form-control"
                                                            v-model="activeItem.content_langs[language.language_code].seo_keywords" />
                                                        <div class="text-muted fs-7"
                                                            v-text="translate('Set a list of keywords that the item is related to. Separate the keywords by adding a comma <code>,</code> between each keyword')">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane fade show active" v-if="activeTab == translate('Attributes')">
                                <div class="d-flex flex-column gap-7 gap-lg-10">
                                    <div class="card card-flush py-4">
                                        <div class="card-header">
                                            <div class="card-title">
                                                <h2 v-text="translate('Colors')"></h2>
                                            </div>
                                        </div>
                                        <div class="card-body pt-0">
                                            <div class="" data-kt-ecommerce-catalog-add-product="auto-options">
                                                <label class="form-label"
                                                    v-text="translate('Choose Product colors')"></label>
                                                <div id="kt_ecommerce_add_product_options">
                                                    <div class="form-group">
                                                        <div class="d-flex flex-column gap-3 mb-2"
                                                            v-for="(color, key) in activeItem.colors">
                                                            <div class="form-group flex flex-wrap align-items-center gap-5"
                                                                v-if="color">
                                                                <color_picker :index="key" @callback="handleColors"
                                                                    :color="color"></color_picker>
                                                                <button @click="activeItem.colors[key] = null"
                                                                    type="button"
                                                                    class="btn btn-sm btn-icon btn-light-danger"><vue-feather
                                                                        type="delete" /></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group mt-5">
                                                        <button type="button" @click="activeItem.colors.push({})"
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-header">
                                            <div class="card-title">
                                                <h2 v-text="translate('Sizes')"></h2>
                                            </div>
                                        </div>
                                        <div class="card-body pt-0">
                                            <div class="" data-kt-ecommerce-catalog-add-product="auto-options">
                                                <label class="form-label"
                                                    v-text="translate('Choose Product sizes')"></label>
                                                <div id="kt_ecommerce_add_product_options">
                                                    <div class="form-group">
                                                        <div class="d-flex flex-column gap-3 mb-2"
                                                            v-for="(size, key) in activeItem.sizes">
                                                            <div class="form-group flex flex-wrap align-items-center gap-5"
                                                                v-if="size != null">
                                                                <input v-model="activeItem.sizes[key]" type="text"
                                                                    class="form-control mw-100 w-200px"
                                                                    :placeholder="translate('Size')">
                                                                <button @click="activeItem.sizes[key] = null"
                                                                    type="button"
                                                                    class="btn btn-sm btn-icon btn-light-danger"><vue-feather
                                                                        type="delete" /></button>
                                                            </div>
                                    ...
                                    <div class="card card-flush py-4">
                                        <div class="card-header">
                                            <div class="card-title">
                                                <h2 v-text="translate('Variations')"></h2>
                                            </div>
                                        </div>
                                        <div class="card-body pt-0">
                                            <div class="" data-kt-ecommerce-catalog-add-product="auto-options">
                                                <label class="form-label"
                                                    v-text="translate('Add Product Variations')"></label>
                                                <div id="kt_ecommerce_add_product_options">
                                                    <div class="form-group"
                                                        v-for="(variant, key) in activeItem.variants">
                                                        <div class="d-flex flex-column gap-3" v-if="variant">
                                                            <div
                                                                class="form-group d-flex flex-wrap align-items-center gap-5">
                                                                <div class="w-100 w-md-200px">
                                                                    <input v-model="activeItem.variants[key].title"
                                                                        type="text" class="form-control mw-100 w-200px"
                                                                        :placeholder="translate('title')" />
                                                                </div>
                                                                <input v-model="activeItem.variants[key].value"
                                                                    type="text" class="form-control mw-100 w-200px"
                                                                    :placeholder="translate('Variation')" />

                                                                <button @click="activeItem.variants[key] = null"
                                                                    type="button"
                                                                    class="btn btn-sm btn-icon bg-gray-100 flex gap-4">
                                                    ...
                                                    <div class="form-group mt-5">
                                                        <button @click="activeItem.variants.push({})" type="button"
                                                            class="btn btn-sm btn-light-primary">
                            ...
                            <div class="tab-pane fade show active" v-if="activeTab == translate('Pricing')">
                                ...
                                <div class="card card-flush py-4">
                                    <div class="card-header">
                                        <div class="card-title">
                                            <h2 v-text="translate('Pricing')"></h2>
                                        </div>
                                    </div>
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="row mb-10">
                                            <div class="col-md-8 fv-row">
                                                <label class="required fs-6 fw-semibold form-label mb-2"
                                                    v-text="translate('Tax')"></label>
                                                <div class="w-full">
                                                    <form_field :item="activeItem.product_fields"
                                                        :column="{required: true, key:'tax_type',title: translate('Tax') , column_type:'select', text_key: 'title', column_key: 'value', data:taxsTypes}">
                                                    </form_field>
                                                </div>
                                            </div>
                                            <div class="col-md-4 fv-row">
                                                ...
                                                <div class="position-relative">
                                                    <input :disabled="!activeItem.product_fields.tax_type" type="number"
                                                        v-model="activeItem.product_fields.tax_amount"
                                                        class="form-control form-control-solid" />
                                                    <div
                                                        class="position-absolute translate-middle-y top-50 text-muted end-0 me-3">
                                                        <span v-if="activeItem.product_fields.tax_type == 'percent'"> %
                                                        </span>
                                                        <span v-if="activeItem.product_fields.tax_type == 'fixed'"> $
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mb-10">
                                            <div class="col-md-8 fv-row">
                                                <label class="required fs-6 fw-semibold form-label mb-2"
                                                    v-text="translate('Vat')"></label>
                                                <div class="w-full">
                                                    <form_field :item="activeItem.product_fields"
                                                        :column="{required: true, key:'vat_type',title: translate('Vat') , column_type:'select', text_key: 'title', column_key: 'value', data:vatsTypes}">
                                                    </form_field>
                                                </div>
                                            </div>
                                            <div class="col-md-4 fv-row">
                                                ...
                                                <div class="position-relative">
                                                    <input :disabled="!activeItem.product_fields.vat_type" type="number"
                                                        v-model="activeItem.product_fields.vat_amount"
                                                        class="form-control form-control-solid" />
                                                    <div
                                                        class="position-absolute translate-middle-y top-50 text-muted end-0 me-3">
                                                        <span v-if="activeItem.product_fields.vat_type == 'percent'"> %
                                                        </span>
                                                        <span v-if="activeItem.product_fields.vat_type == 'fixed'"> $
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="d-flex flex-column gap-7 gap-lg-10">
                                    <div class="card card-flush py-4">
                                        <div class="card-header flex flex-nowrap">
                                            ...
                                            <div class="flex-end">
                                                <a href="javascript:;"
                                                    @click="activeItem.images.push({path: '/uploads/img/placeholder.png'})"
                                        ...
                                        <div class="card-body pt-0" :key="activeItem.images">
                                            <div class="w-full relative flex gap-2 py-2"
                                                v-for="(image, imageKey) in activeItem.images">
                                                <vue-medialibrary-field class="w-full" v-if="image"
                                                    @clear="() => { activeItem.images[imageKey] = null; }"
                                                    @changed="(val) => { activeItem.images[imageKey] = {path: val}; }"
                                                    :conf="conf" :filepath="image.path" />
                                                <vue-feather v-if="image && imageKey > 0"
                                                    @click="activeItem.images[imageKey] = null"
                                                    class="absolute bottom-25 cursor-pointer p-2 px-4 right right-4 vue-feather vue-feather--delete w-4"
                                                    type="delete"></vue-feather>
                                            </div>
                                            <div class="text-muted fs-7 py-2"
                                                v-text="translate('Set the product media gallery')"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card-header pt-5">
                                            <div class="card-title d-flex flex-column">
                                                <div class="d-flex align-items-center"><span
                                                        class="fs-4 fw-semibold text-gray-500 me-1 align-self-start">{{currency}}</span><span
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="/admin/products" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5"
        ...
        <side-form-create ref="activeFormCreate" @callback="closeSide" :auth="auth" :key="showAddCategory" :conf="conf"
            :model="'ProductCategory.create'" v-if="showAddCategory" :columns="content.fillable_category"
            class="col-md-3" />
